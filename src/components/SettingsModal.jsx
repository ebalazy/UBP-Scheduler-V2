                ...
                <div className="mt-8 flex justify-between items-center bg-gray-50 dark:bg-gray-800 -mx-6 -mb-6 p-4 rounded-b-lg border-t dark:border-gray-700">
                    ...
                    <div className="flex justify-between md:justify-end space-x-4">
                        <button
                            ...
                            className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 text-sm font-bold flex items-center"
                        >
                        ...
                        <button
                            onClick={onClose}
                            className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md text-sm font-bold shadow-sm"
                        >
                            Done
                        </button>
                    </div>
